...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // position the viewport at the top center of the screen
      "fixed top-4 left-1/2 z-[100] flex max-h-screen w-[calc(100%-2rem)] -translate-x-1/2 flex-col gap-2 md:max-w-[420px]",
      className,
    )}
    {...props}
  />
